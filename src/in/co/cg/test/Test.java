...
public class Test {
	public static void main(String[] args) {
		...
		Set<Car> carSet = new HashSet<Car>();// HashSet with Car class
		...
		System.out.println();
		Set<CellPhone> cellSet = new HashSet<CellPhone>();// HashSet with Cellphone class
		...
		System.out.println();
		Set<Laptop> laptopSet = new HashSet<Laptop>(); // HashSet with Laptop class
		...
		System.out.println();
		Set<Television> TVSet = new HashSet<Television>(); // HashSet with Television class
		...
		System.out.println();
		Set<School> sch = new HashSet<School>(); // HashSet with School class
